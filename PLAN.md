...
- [] **add Leaflet map and visible grid cells** – render cells of fixed size around the player  
- [] **use `luck()` for deterministic token spawning** – consistent world each reload  
- [] **limit interaction to nearby cells (range 3)** – highlight reachable cells  
